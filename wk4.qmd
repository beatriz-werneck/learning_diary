...
**Image 01: Belo Horizonte Zoning Map**
...
::: {style="text-align: center;"}
**Image 02: Informal settlement on north of Belo Horizonte**

```{r}
#| echo: false

knitr::include_graphics('img/wk4_f2.png')
```

Informal settlement in the PA1 and PA2 zones **Source**: Author
:::
